...
//        System.out.println(DB.qaEmployeesList);
    ...
    int capacity = DB.getALLEmployeesList().size();
        ...
        if(name != null){
                    ...
                    if(employeeArrayListAll.get(j).getOccupation().equals("qa")){
                        for(int i=0; i<DB.qaEmployeesList.size(); i++){
                            ...
                            if(convertto != null ){
                                ...
                                }else if(convertto == DB.qaEmployeesList.get(i).getOccupation()){
                                    Gson gson = new Gson();
                                ...
                                Gson gson = new Gson();
                                String rezjson = gson.toJson("Empty convertto");
                                return rezjson;
                            }
                        ...
                        for (int i =0 ; i<DB.devEmployeesList.size(); i++){
                            ...
                            if(convertto != null ){
                                if(name.equals(DB.devEmployeesList.get(i).getName())){
                                    ...
                                    if(convertto != DB.devEmployeesList.get(i).getOccupation()){
                                    ...
                                    else if(convertto == DB.devEmployeesList.get(i).getOccupation()){
                                        Gson gson = new Gson();
                                        String rezjson = gson.toJson("You're trying to set the same occupation");
                                        return rezjson;
            ...
            Gson gson = new Gson();
            String rezjson=gson.toJson("Converted to other occupation");
            return  rezjson;
